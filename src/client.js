...
class Bitrix24Client {
  constructor({ domain, webhookSecret, log }) {
    this.domain = domain;
   ...
   */
  async registerBot({ botName, botCode }) {
    // Set bot handler URL
    const webhookUrl = options.webhookUrl || `https://your-domain.com/bitrix24/webhook/${this.domain}`;
